classdef SimulationController < ...
    ...
    properties ( Access = private )
        ...
        % Spinner for the maximum magnitude value.
        MaximumMagnitudeSpinner(:, 1) matlab.ui.control.Spinner ...
            {mustBeScalarOrEmpty}
        % Spinner for the input change interval value.
        InputChangeIntervalSpinner(:, 1) matlab.ui.control.Spinner ...
            {mustBeScalarOrEmpty}
    ...
    methods ( Access = protected )
            ...
            switch obj.Model.SimulationStatus
                ...
                case {"Initializing", "Initialized"}
                    ...
                    set( [obj.MassSpinner, ...
                        ...
                        obj.MaximumMagnitudeSpinner,...
                        obj.InputChangeIntervalSpinner,...
                        obj.StartStopButton, ...                        
        ...
        function setup( obj )
            ...
            forceGrid = uigridlayout( forcePanel, ...
                "ColumnWidth", ["fit", "1x"], ...
                "RowHeight", repelem( "fit", 2 ) );

            % Add a label and spinner for the maximum magnitude.
            uilabel( forceGrid, "Text", "Maximum Magnitude (N)", ...
                "FontWeight", "bold" );
            obj.MaximumMagnitudeSpinner = uispinner( forceGrid, ...
                "Limits", [0, Inf], ...
                "LowerLimitInclusive", "off", ....
                "UpperLimitInclusive", "off", ...
                "Value", 100, ...
                "ValueChangingFcn", @obj.onMaximumMagnitudeChanged );

            % Add a label and spinner for the input change interval.
            uilabel( forceGrid, "Text", "Input Change Interval (s)", ...
                "FontWeight", "bold" );
            obj.InputChangeIntervalSpinner = uispinner( forceGrid, ...
                "Limits", [0, Inf], ...
                "LowerLimitInclusive", "off", ....
                "UpperLimitInclusive", "off", ...
                "Value", 5, ...
                "ValueChangingFcn", @obj.onInputChangeIntervalChanged );
    ...
    methods ( Access = private )
        ...
        function onMaximumMagnitudeChanged( obj, ~, ~ )
            %ONMAXIMUMMAGNITUDECHANGED Change the maximum magnitude of the force
            % parameter in the Simulink model.

            obj.Model.MaximumMagnitude = obj.MaximumMagnitudeSpinner.Value;

        end % onMaximumMagnitudeChanged

        function onInputChangeIntervalChanged( obj, ~, ~ )
            %ONINPUTCHANGEINTERVALCHANGED Change the input change interval of the force
            % parameter in the Simulink model.

            obj.Model.InputChangeInterval = obj.InputChangeIntervalSpinner.Value;

        end % onInputChangeIntervalChanged
